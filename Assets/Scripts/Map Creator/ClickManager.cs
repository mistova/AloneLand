...
public class ClickManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                clickedSquarePos = new Vector2(raycastHit.transform.localPosition.x, raycastHit.transform.localPosition.z);
        ...
        else if (Input.GetMouseButton(0))
        {
            ...
            if (Physics.Raycast(Camera.main.ScreenPointToRay(Input.mousePosition), out raycastHit, 100f, layerMask))
            {
                Vector2 vec2 = new Vector2(raycastHit.transform.localPosition.x, raycastHit.transform.localPosition.z);
